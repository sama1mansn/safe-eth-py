...
MASTER_COPIES: Dict[EthereumNetwork, List[Tuple[str, int, str]]] = {
    ...
    EthereumNetwork.OPBNB_TESTNET: [
        ("0xE2CF742b554F466d5E7a37C371FD47C786d2FBc0", 11170480, "1.3.0+L2"),
        ("0xF846A23a8953F032d37A917746903300BeEF5829", 11170486, "1.3.0"),
    ],
    EthereumNetwork.OPBNB_MAINNET: [
        ("0xE2CF742b554F466d5E7a37C371FD47C786d2FBc0", 6295620, "1.3.0+L2"),
        ("0xF846A23a8953F032d37A917746903300BeEF5829", 6295625, "1.3.0"),
    ],
    EthereumNetwork.BINANCE_SMART_CHAIN_TESTNET: [
        ("0xE2CF742b554F466d5E7a37C371FD47C786d2FBc0", 34450458, "1.3.0+L2"),
        ("0xF846A23a8953F032d37A917746903300BeEF5829", 34450458, "1.3.0"),
    ],
}
...
PROXY_FACTORIES: Dict[EthereumNetwork, List[Tuple[str, int]]] = {
    ...
    EthereumNetwork.OPBNB_TESTNET: [
        ("0x9fea7F7C69f14aa1a7d62cC9D468fEB2F9371CB3", 11170442), # v1.3.0
    ],
    EthereumNetwork.OPBNB_MAINNET: [
        ("0x9fea7F7C69f14aa1a7d62cC9D468fEB2F9371CB3", 6295581), # v1.3.0
    ],
    EthereumNetwork.BINANCE_SMART_CHAIN_TESTNET: [
        ("0x9fea7F7C69f14aa1a7d62cC9D468fEB2F9371CB3", 34450445), # v1.3.0
    ],
}
